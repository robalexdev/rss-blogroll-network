...
params:
  ...
  relme:
    https://words.filippo.io/: true
  last_post_title: Turn Dependabot Off
  last_post_description: I recommend turning Dependabot off and replacing it with
    a pair of scheduled GitHub Actions, one running govulncheck, and the other running
    CI against the latest version of your dependencies.
  last_post_date: "2026-02-20T19:48:08Z"
  last_post_link: https://words.filippo.io/dependabot/
  last_post_categories: []
  last_post_language: ""
  last_post_guid: 24b6c4650b6cc44eef9b8028335e838c
  score_criteria:
    cats: 0
    description: 0
    feedlangs: 0
