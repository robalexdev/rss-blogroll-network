...
params:
  ...
  relme:
    https://yetanothermathprogrammingconsultant.blogspot.com/: true
  last_post_title: Crack the passcode
  last_post_description: In this puzzle [1,2], we need to determine what the 3-digit
    passcode is, using a few hints. Each digit is an integer between 0 and 9. The
    hints are:Let's see if we can shoehorn this into a MIP model
  last_post_date: "2025-12-09T09:10:00Z"
  last_post_link: https://yetanothermathprogrammingconsultant.blogspot.com/2025/12/crack-passcode.html
  last_post_categories:
  - Modeling
  - Puzzle
  last_post_language: ""
  last_post_guid: 4caa12e42d3bb4baef69c1e5f886db1f
  score_criteria:
    cats: 5
    description: 3
    feedlangs: 0
