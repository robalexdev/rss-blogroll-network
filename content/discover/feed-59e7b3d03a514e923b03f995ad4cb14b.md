...
params:
  ...
  relme:
    https://yetanothermathprogrammingconsultant.blogspot.com/: true
  last_post_title: Clock problem
  last_post_description: I denote the three hands as \(h_1\), \(h_2\), and \(h_3\).
    The hand \(h_1\) is the left lower one, \(h_2\) the left upper one, and \(h_3\)
    the hand on the right. Let's get the relative positions of
  last_post_date: "2025-11-11T12:43:00Z"
  last_post_link: https://yetanothermathprogrammingconsultant.blogspot.com/2025/11/clock-problem.html
  ...
  - Puzzle
  last_post_language: ""
  last_post_guid: b52699e4fe442ee7b58111dcf876fc46
  score_criteria:
    cats: 5
    description: 3
    feedlangs: 0
