...
params:
  ...
  relme:
    https://lmika.org/: true
  last_post_title: 'Release: Dequoter 0.1.9'
  last_post_description: 'I figured it was time to start releasing some of the small
    apps I make to assist me. I’ll start with Dequoter, one of the smaller ones. Until
    today, it was not in a fit enough state to release: the'
  last_post_date: "2026-05-05T20:58:38+10:00"
  last_post_link: https://lmika.org/2026/05/05/release-dequoter.html
  last_post_categories: []
  last_post_language: ""
  last_post_guid: f7dce88f451538fdbdb2e3d1a64c70b2
  score_criteria:
    cats: 0
    description: 0
    feedlangs: 1
