...
params:
  ...
  last_post_title: The Continuum From Static to Dynamic
  last_post_description: |-
    Dan Abramov in “Static as a Server”:

    Static is a server that runs ahead of time.

    “Static” and “dynamic” don’t have to be binaries that describe an entire application architecture. As
  last_post_date: "2025-06-11T19:00:00Z"
  last_post_link: https://blog.jim-nielsen.com/2025/continuum-from-static-to-dynamic/
  last_post_categories: []
  last_post_language: ""
  last_post_guid: c183286257cdb363109e864198a3055d
  score_criteria:
    cats: 0
    description: 0
    feedlangs: 0
