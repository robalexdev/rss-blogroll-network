...
params:
  ...
  relme:
    https://addyosmani.com/: true
  last_post_title: Cognitive Surrender
  last_post_description: Cognitive offloading is delegating to the AI and still owning
    the answer. Cognitive surrender is when the AI's output quietly becomes your output
    and there is nothing left to check. For software
  last_post_date: "2026-05-05T00:00:00Z"
  last_post_link: https://addyosmani.com/blog/cognitive-surrender/
  last_post_categories: []
  last_post_language: ""
  last_post_guid: b8ac66a4a52af4b7ffb7b2c4cf4aad33
  score_criteria:
    cats: 0
    description: 3
    feedlangs: 0
